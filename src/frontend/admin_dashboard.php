...
?>
<?php
$pageTitle = 'Admin Dashboard | Dream';
$bodyPage = 'admin';
...
?>
        ...
        <section class="table-card admin-wide" id="users">
          <div class="panel-header">
            ...
            <div class="panel-actions" style="min-width:260px; flex: 1; display:flex; justify-content:flex-end; gap:10px; align-items:center; flex-wrap:wrap;">
              <a class="btn small user-action-btn" href="register.php?next=admin" style="width:auto; min-width:120px; max-width:180px; text-align:center; flex:0 0 auto;">Add User</a>
  ...
  <script>
    (function () {
      const API = '/project_club/src/backend/users.php';
